...
String agAdi = "XXXXXX";                 //Ağımızın adını buraya yazıyoruz.    
...
DHT11.read(dht11Pin);
 sicaklik = (float)DHT11.temperature;
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=YHHXGYINGATH84GS";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.                                   //Göndereceğimiz sıcaklık değişkeni
  veri += "&field1=";
